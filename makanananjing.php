...
<body>
  <div class="w-full h-screen  ">
    ...
    <div class="w-1/2 flex  px-3 mt-5 mb-5">
      ...
      <div class="w-1/2 ">Makanan Anjing </div>
    </div>
    <!-- row seacrh -->
    ...
    $sql = "SELECT * FROM makanananjing where merk ='Royalcanin' ";
    ...
    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
      <div class="border p-5 ">
        ...
        <?php echo $row['harga']; ?>
        <br>
        <form action="halamantransaksi_Manjing.php" method="POST">
    ...
    <?php
    // buat gambar ke2
    $sql = "SELECT * FROM makanananjing where merk ='Pedigree' ";
    $result = mysqli_query($link, $sql);
    ?>
    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
      <div class="border p-5 ">
    ...
    <?php
    // buat gambar ke 3
    $sql = "SELECT * FROM makanananjing where merk ='Happydog' ";
    $result = mysqli_query($link, $sql);
    ?>
    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
      <div class="border p-5 ">
