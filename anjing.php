...
<body>
  <div class="w-full h-screen  ">
    ...
    $sql = "SELECT * FROM anjing where jenis ='pudel' ";
    ...
    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
      <div class="border p-5 ">
        ...
        <?php echo $row['harga']; ?>
        <br>
        <form action="halamantransaksi_anjing.php" method="POST">
    ...
    <?php
    // buat gambar ke2
    $sql = "SELECT * FROM anjing where jenis ='cihuhua' ";
    $result = mysqli_query($link, $sql);
    ?>
    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
      <div class="border p-5 ">
    ...
    <?php
    // buat gambar ke 3
    $sql = "SELECT * FROM anjing where jenis ='pomerania' ";
    $result = mysqli_query($link, $sql);
    ?>
    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
      <div class="border p-5 ">
