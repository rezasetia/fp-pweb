...
<body>
      ...
      <div class="  flex  w-full ">
        ...
        <div class=" w-1/4     ">
          <div class="w-full    mx-auto">
            <div class=" w-full ">
              <a href="profil.php"><img src="img/Group 3.png" alt="" width="30" class="mx-auto"></a>
    ...
    <div class="w-1/2 flex  px-3 mt-5 mb-5">
      <div class="w-1/2 ">
        <div class="w-full flex">
          <div class="w-2/3 text-center"><a href="makananHewan.php">kategori Hewan</a></div>
  ...
  <form action="pencarian.php" method="post" class="flex items-center">
    ...
    $sql = "SELECT * FROM kucing where jenis ='Anggora' ";
    ...
    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
      <div class="border p-5 ">
        ...
        <?php echo $row['harga']; ?>
        <br>
        <form action="halamantransaksi_kucing.php" method="POST">
          <input type="hidden" name="Id" value="<?php echo $row['Id']; ?>">
          <button type="submit" class="border ml-5 w-1/4 rounded-md bg-red-400">Beli</button>
        </form>
      </div>
      </tr>
    ...
    <?php
    // buat gambar ke2
    $sql = "SELECT * FROM kucing where jenis ='Percia' ";
    $result = mysqli_query($link, $sql);
    ?>
    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
      <div class="border p-5 ">
    ...
    <?php
    // buat gambar ke 3
    $sql = "SELECT * FROM kucing where jenis ='Ragdoll' ";
    $result = mysqli_query($link, $sql);
    ?>
    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
      <div class="border p-5 ">
