...
<body>
  <div class="container absolute top-0 left-0 mx-10">
    <div class="contents text-justify ">
      <img src="img/image 1.jpg" alt="makanankucing" width="73" class="float-left">
    ...
    <div class="flex flex-col md:flex-row">
      ...
      <div class="container mx-5 ml-28 
        ...
        <div class="text-8xl font-serif mt-36  ">
          <p class="text-amber-900">Cel<a class="text-white">ebrating the</a></p>
          <p class="text-amber-900">Coura<a class="text-white">ge <a class="text-amber-900">and</a>
