...
<body>
  <div class="w-full h-screen  ">
    ...
    <div class="w-1/2 flex  px-3 mt-5 mb-5">
      <div class="w-1/2 ">
        <div class="w-full flex">
          <div class="w-2/3 text-center"><a href="Dasboard.php">Home Page</a></div>
    ...
    </div <!-- row baris pilihan kucing anjing burung kelinci-->
    <div class="relative inline-block  w-64">
      <select id="kategori" class="block appearance-none w-full bg-white border border-gray-300 hover:border-gray-400
     px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
        <option value="kategoriHewan">Katagori Hewan</option>
    ...
    <div id="gambar-kategori" class="mt-4 px-4 flex flex-wrap ">
      <!-- Gambar Kucing -->
      <a href="kucing.php"><img src="img/kucing1.jpg" alt="Kucing" class="w-64 h-64 object-cover mr-4 mb-4"></a>
      <a href="anjing.php"> <img src="img/anjing1.jpg" alt="Kucing" class="w-64 h-64 object-cover mr-4 mb-4"></a>
    ...
    <div class=" bg-gray-300 flex mt-5">
      ...
      <!-- kotak 2 -->
      <div class="w-1/4  p-2">
        <p class="text-orange-600 font-bold">Find Us</p>
