      ...
      <div class="  flex  w-full ">
        ...
        <div class=" w-1/4 text-center">
          <div class="flex w-full text-center justify-center">
            <div> <a href="brand.php">Hewan</a> </div>
            </div>
          </div>
          <!-- untuk hewan -->
          <div class=" w-1/4 text-center">
...
<div class="relative inline-block  w-64">
  ...
  <div id="gambar-kategori" class="mt-4 px-4 flex flex-wrap ">
    <!-- Gambar Kucing -->
    <a href="makanankucing.php"><img src="img/kucing1.jpg" alt="Kucing" class="w-64 h-64 object-cover mr-4 mb-4"></a>
    <a href="makanananjing.php"><img src="img/anjing1.jpg" alt="Kucing" class="w-64 h-64 object-cover mr-4 mb-4"></a>
