...
<body>
  ...
  <div class="items-center mx-4 mt-10">
    <button class="w-1/3 bg-white text-black font-mono font-semibold rounded-md
     hover:bg-slate-700 btn btn-primary transition-colors"><a href="updatepassword.php">CHANGE PASSWORD</a> </button>
  </div>
